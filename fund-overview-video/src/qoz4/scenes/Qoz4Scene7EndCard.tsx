...
/**
 * 0:55–1:00 — Completed development at sunset, fading to the navy end card.
 */
export const Qoz4Scene7EndCard: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Sequence durationInFrames={HERO_FRAMES} name="Sunset development">
        <BrollScene
          src={['assets/qoz-broll/sunset.mp4', 'assets/qoz-broll/skyline-drone.mp4']}
      ...
      <Sequence from={HERO_FRAMES - DISSOLVE} name="End card">
        <AbsoluteFill style={{opacity: cardOpacity}}>
          ...
          <EndCard
            ...
            subtitle={null}
            tagline="Tax-Efficient Real Estate Investing"
            cta={null}
          />
        </AbsoluteFill>
      </Sequence>
