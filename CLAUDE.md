# Deal-Agent — project notes for Claude
...
- `deal_agent/` — the original 4-agent Claude Agent SDK app and the earlier IC Go/No-Go
  dashboard engine (`deal_agent/ic/`). See `docs/IC_GO_NO_GO.md`.
- Confidential client data (`*.xlsx`, `*.xls`, `*.csv`, `ic_data/*.json`) is git-ignored.
